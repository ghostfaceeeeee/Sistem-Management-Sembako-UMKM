<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight">Edit Produk</h2>
    </x-slot>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input
                                ...
                                class="w-full rounded-xl border px-3 py-2.5"
                            >
                            <p class="mt-1 text-xs text-slate-500">Opsional. Upload ulang jika ingin ganti gambar.</p>
                            @if($product->image)
                                <div class="mt-3">
                                    <img src="{{ asset('storage/' . $product->image) }}"
                                         alt="{{ $product->nama_barang }}"
                                         class="h-24 w-24 rounded-xl border border-slate-300 object-cover">
                                </div>
                            @endif
                            @error('image')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
